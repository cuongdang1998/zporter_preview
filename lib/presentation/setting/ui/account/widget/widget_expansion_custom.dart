...
class ExpandableThemeData {
  ...
  /// If true, the header of [ExpandablePanelCustom] can be clicked by the user to expand or collapse.
  final bool? tapHeaderToExpand;

  /// If true, the body of [ExpandablePanelCustom] can be clicked by the user to expand.
  final bool? tapBodyToExpand;

  /// If true, the body of [ExpandablePanelCustom] can be clicked by the user to collapse.
  final bool? tapBodyToCollapse;

  /// If true, an icon is shown in the header of [ExpandablePanelCustom].
  final bool? hasIcon;
...
/// Determines the placement of the expand/collapse icon in [ExpandablePanelCustom]
