...
class _CalendarState<T extends EventInterface>
  ...
  Widget renderDay(
    ...
    return Container(
      ...
      child: GestureDetector(
        onLongPress: () => _onDayPressed(now, isNextMonthDay, isPrevMonthDay),
        ...
        child: FlatButton(
          ...
          onPressed: widget.disableDayPressed
              ? null
              : () => _onDayPressed(now, isNextMonthDay, isPrevMonthDay),
  ...
  void _onDayPressed(
      DateTime picked, bool isNextMonthDay, bool isPrevMonthDay) {
